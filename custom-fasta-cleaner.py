...
output_dir = os.path.join(proteome_dir, "renamed_files")
...
log_path = os.path.join(proteome_dir, "renaming_custom_summary_log.csv")
log_df.to_csv(log_path, index=False)
print(f"📝 Custom renaming log saved: {log_path}")
